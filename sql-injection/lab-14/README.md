...
- Construct a SQL payload that prepends the `administrator` password to burp collaborator domain and triggers an out-of-band network interaction.
...
- **Phase 4: Password Retrieval**:
  - The user checks the Burp Collaborator tab for a DNS request like `[PASSWORD].<collab-id>.oastify.com`
- **Phase 4: Verification**:
  - The script prompts for the captured password and makes a final login to solve the lab.
